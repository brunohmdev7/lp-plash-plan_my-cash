    ...
    <div className="auth">
      ...
      <main className="auth__card">
        ...
        <p className="auth__sub">
          Entre na plataforma <strong>Plash</strong> e continue planejando seu dinheiro.
        </p>

        {submitted ? (
          <div className="auth__notice">
            Login simulado com sucesso! Conecte aqui a sua API de autenticação.
          </div>
        ) : null}
        ...
        <form className="auth__form" onSubmit={handleSubmit}>
          ...
          <div className="auth__row">
            ...
            <a href="#recuperar" className="auth__link">Esqueci minha senha</a>
          </div>
        ...
        <p className="auth__foot">
          Ainda não tem conta? <Link to="/auth/register" className="auth__link">Criar conta gratuita</Link>
        </p>
      </main>
    </div>
  );
